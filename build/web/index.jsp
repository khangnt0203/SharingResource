<%-- 
    Document   : index
    Created on : August 10, 2021, 2:07:31 PM
    Author     : SE140281
--%>
    ...
    <body>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div id="formFooter">
                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8084/SharingResources/LoginGoogleServlet&response_type=code&client_id=791451320811-c01oum9i9c8om4edgk713eki838dmhkk.apps.googleusercontent.com&approval_prompt=force">
			Login With Google</a>
                </div>
            </div>
        </div>
